...
const FutaRejesho = ({navigation, route}) => {
...
const handleDeletePost = async () => {
    ...
    try {
      await axios.delete(EndPoint + `/DeleteRejeshoView/${postId}/delete/`, {
        headers: {
...
<View style={{
  ...
  }}>Futa rejesho la  {JinaKamiliLaMteja}</Text>
</View>
